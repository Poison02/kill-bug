...
public class ChatServiceImpl implements IChatService {
    ...
    public List<ChatRecordVO> getChatRecords(Long uId, Integer type) {
        ...
        queryWrapper.and(qw ->
                        qw.eq(PrivateMessage::getReceiverId, userId)
                                .eq(PrivateMessage::getSenderId, uId))
                .or(qw ->
                        qw.eq(PrivateMessage::getSenderId, userId)
                                .eq(PrivateMessage::getReceiverId, uId));
        ...
        queryWrapper.eq("type", type)
                .and(wrapper ->
                        wrapper.nested(nestedWrapper ->
                                        nestedWrapper.eq("sender_id", senderId)
                                                .eq("receiver_id", receiverId))
                                .or(nestedWrapper ->
                                        nestedWrapper.eq("receiver_id", senderId)
